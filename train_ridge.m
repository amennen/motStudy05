function [scratchpad] = train_ridge(trainpats,traintargs,penalty)
% MY CHANGE: change it so the TRAINPATS is the opposite orientation 
% (nTRs x nVoxels)
...
sanity_check(trainpats,traintargs,penalty);

[nTimepoints nVox] = size(trainpats);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [] = sanity_check(trainpats,traintargs,penalty)
