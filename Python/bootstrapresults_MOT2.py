...
# LOAD ALL DATA
pickle_in = open("/Volumes/norman/amennen/PythonMot2/evidencebystim_glmclassifier_alpha100_intercept_motion.pickle","rb")
evbystim = pickle.load(pickle_in)
# now specify path for betas ps
motpath = '/Volumes/norman/amennen/motStudy02_transferred/'
behavioral_data = '/Volumes/norman/amennen/motStudy02_transferred/BehavioralData/'
savepath = '/Volumes/norman/amennen/PythonMot2/'

all_sub = np.array([8 ,12, 14, 15, 18 ,22 ,31, 16, 28, 20, 26, 27, 30, 32])
...
nstim = 10
data_dir = '/Volumes/norman/amennen/PythonMot2/RecallPat/'
