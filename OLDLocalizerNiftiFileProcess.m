function OLDLocalizerNiftiFileProcess(subjectNum,crossval,featureSelect,prev,scanNow,scanNum,SESSION,runNum)
...
[newpattern t] = OLDGetSessionInfoRT(subjectNum,SESSION,behavioral_dir,keepTR);
