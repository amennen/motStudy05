...
%% first practice set
%mot_realtime05(SUBJECT, SETUP, 1, 0, 0);

% this will continue to train test and practice MOT, then move on to
% MOT_Practice, MOT_PREPr5
mot_realtime05(SUBJECT,MOT_PRACTICE,1,0,0);
%mot_realtime05(SUBJECT, FAMILIARIZE2, 1, 0, 0); %continue because want to not go through the break
